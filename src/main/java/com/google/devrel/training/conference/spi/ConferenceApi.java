...
/**
    ...
    public List<Conference> getConferencesCreated(final User user) throws UnauthorizedException {
        ...
        return ofy().load().type(Conference.class).ancestor(userKey).list();
    }
    ...
    @ApiMethod(
    		name ="getConferencesFiltered2",
    		path="getConferencesFiltered2",
    		httpMethod=HttpMethod.POST
    		)
    		public List<Conference> getConferencesFiltered2 () {
        ...
        if (user == null) {
       	...
       	WrappedBoolean result = ofy().transact(new Work<WrappedBoolean>() {
            ...
            public WrappedBoolean run() {
                ...
                if (conference == null) {
                    return new WrappedBoolean(false, "No Conference found");
                }
